...
export function SignupForm() {
  ...
  if (state.message?.startsWith("Your account was created")) {
    return <div><p className="notice error" role="alert">{state.message}</p><p className="form-help"><Link href="/verify-email/resend">Request a new verification link</Link></p></div>;
  }
